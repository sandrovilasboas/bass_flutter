...
/// Bindings para BASS audio library
class BASS {
  ...
  int BASS_SetConfigPtr(int option, ffi.Pointer<ffi.Void> value) {
    return _BASS_SetConfigPtr$1(option, value);
  }
  ...
  late final _BASS_SetConfigPtr$1 =
      _BASS_SetConfigPtrPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>)
      >();

  ffi.Pointer<ffi.Void> BASS_GetConfigPtr(int option) {
    return _BASS_GetConfigPtr$1(option);
  }
  ...
  late final _BASS_GetConfigPtr$1 =
  ...
  late final _BASS_GetDeviceInfoPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(DWORD, ffi.Pointer<BASS_DEVICEINFO>)>
      >('BASS_GetDeviceInfo');
  late final _BASS_GetDeviceInfo =
      _BASS_GetDeviceInfoPtr.asFunction<
  ...
  int BASS_SetDevice(int device) {
    return _BASS_SetDevice(device);
  }
  ...
  late final _BASS_GetDevicePtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
    'BASS_GetDevice',
  );
  ...
  late final _BASS_StopPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'BASS_Stop',
  );
  ...
  late final _BASS_PausePtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'BASS_Pause',
  );
  ...
  late final _BASS_IsStartedPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
    'BASS_IsStarted',
  );
  late final _BASS_IsStarted = _BASS_IsStartedPtr.asFunction<int Function()>();

  int BASS_Update(int length) {
    return _BASS_Update(length);
  }
  ...
  int BASS_SetVolume(double volume) {
    return _BASS_SetVolume(volume);
  }
  ...
  int BASS_Set3DFactors(double distf, double rollf, double doppf) {
    return _BASS_Set3DFactors(distf, rollf, doppf);
  }

  late final _BASS_Set3DFactorsPtr =
      _lookup<
  ...
  int BASS_Get3DFactors(
    ...
    return _BASS_Get3DFactors(distf, rollf, doppf);
  }

  late final _BASS_Get3DFactorsPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
        ...
        >
      >('BASS_Get3DFactors');
  late final _BASS_Get3DFactors =
      _BASS_Get3DFactorsPtr.asFunction<
        int Function(
          ffi.Pointer<ffi.Float>,
          ffi.Pointer<ffi.Float>,
          ffi.Pointer<ffi.Float>,
  ...
  int BASS_Set3DPosition(
    ...
    return _BASS_Set3DPosition(pos, vel, front, top);
  }

  late final _BASS_Set3DPositionPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
        ...
        >
      >('BASS_Set3DPosition');
  late final _BASS_Set3DPosition =
      _BASS_Set3DPositionPtr.asFunction<
        int Function(
          ffi.Pointer<BASS_3DVECTOR>,
          ffi.Pointer<BASS_3DVECTOR>,
          ffi.Pointer<BASS_3DVECTOR>,
  ...
  int BASS_Get3DPosition(
    ...
    return _BASS_Get3DPosition(pos, vel, front, top);
  }

  late final _BASS_Get3DPositionPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
            ffi.Pointer<BASS_3DVECTOR>,
        ...
        >
      >('BASS_Get3DPosition');
  late final _BASS_Get3DPosition =
      _BASS_Get3DPositionPtr.asFunction<
        int Function(
          ffi.Pointer<BASS_3DVECTOR>,
          ffi.Pointer<BASS_3DVECTOR>,
          ffi.Pointer<BASS_3DVECTOR>,
  ...
  int BASS_PluginEnable(int handle, int enable) {
    return _BASS_PluginEnable(handle, enable);
  }
  ...
  ffi.Pointer<BASS_PLUGININFO> BASS_PluginGetInfo(int handle) {
    return _BASS_PluginGetInfo(handle);
  }

  late final _BASS_PluginGetInfoPtr =
      _lookup<
        ffi.NativeFunction<ffi.Pointer<BASS_PLUGININFO> Function(HPLUGIN)>
      >('BASS_PluginGetInfo');
  late final _BASS_PluginGetInfo =
      _BASS_PluginGetInfoPtr.asFunction<
  ...
  int BASS_SampleLoad(
    ...
    return _BASS_SampleLoad(mem, file, offset, length, max, flags);
  }

  late final _BASS_SampleLoadPtr =
      _lookup<
        ffi.NativeFunction<
          HSAMPLE Function(
            BOOL,
        ...
        >
      >('BASS_SampleLoad');
  late final _BASS_SampleLoad =
      _BASS_SampleLoadPtr.asFunction<
  ...
  int BASS_SampleCreate(int length, int freq, int chans, int max, int flags) {
    return _BASS_SampleCreate(length, freq, chans, max, flags);
  }

  late final _BASS_SampleCreatePtr =
      _lookup<
        ffi.NativeFunction<HSAMPLE Function(DWORD, DWORD, DWORD, DWORD, DWORD)>
      >('BASS_SampleCreate');
  late final _BASS_SampleCreate =
      _BASS_SampleCreatePtr.asFunction<int Function(int, int, int, int, int)>();

  int BASS_SampleFree(int handle) {
    return _BASS_SampleFree(handle);
  }
  ...
  int BASS_SampleSetData(int handle, ffi.Pointer<ffi.Void> buffer) {
    return _BASS_SampleSetData(handle, buffer);
  }

  late final _BASS_SampleSetDataPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(HSAMPLE, ffi.Pointer<ffi.Void>)>
      >('BASS_SampleSetData');
  late final _BASS_SampleSetData =
      _BASS_SampleSetDataPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>)
      >();

  int BASS_SampleGetData(int handle, ffi.Pointer<ffi.Void> buffer) {
    return _BASS_SampleGetData(handle, buffer);
  }

  late final _BASS_SampleGetDataPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(HSAMPLE, ffi.Pointer<ffi.Void>)>
      >('BASS_SampleGetData');
  late final _BASS_SampleGetData =
      _BASS_SampleGetDataPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>)
      >();

  int BASS_SampleGetInfo(int handle, ffi.Pointer<BASS_SAMPLE> info) {
    return _BASS_SampleGetInfo(handle, info);
  }

  late final _BASS_SampleGetInfoPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(HSAMPLE, ffi.Pointer<BASS_SAMPLE>)>
      >('BASS_SampleGetInfo');
  late final _BASS_SampleGetInfo =
      _BASS_SampleGetInfoPtr.asFunction<
        int Function(int, ffi.Pointer<BASS_SAMPLE>)
      >();

  int BASS_SampleSetInfo(int handle, ffi.Pointer<BASS_SAMPLE> info) {
    return _BASS_SampleSetInfo(handle, info);
  }

  late final _BASS_SampleSetInfoPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(HSAMPLE, ffi.Pointer<BASS_SAMPLE>)>
      >('BASS_SampleSetInfo');
  late final _BASS_SampleSetInfo =
      _BASS_SampleSetInfoPtr.asFunction<
        int Function(int, ffi.Pointer<BASS_SAMPLE>)
      >();

  int BASS_SampleGetChannel(int handle, int flags) {
    return _BASS_SampleGetChannel(handle, flags);
  }
  ...
  int BASS_SampleGetChannels(int handle, ffi.Pointer<HCHANNEL> channels) {
    return _BASS_SampleGetChannels(handle, channels);
  }

  late final _BASS_SampleGetChannelsPtr =
      _lookup<
        ffi.NativeFunction<DWORD Function(HSAMPLE, ffi.Pointer<HCHANNEL>)>
      >('BASS_SampleGetChannels');
  late final _BASS_SampleGetChannels =
      _BASS_SampleGetChannelsPtr.asFunction<
        int Function(int, ffi.Pointer<HCHANNEL>)
      >();

  int BASS_SampleStop(int handle) {
    return _BASS_SampleStop(handle);
  }
  ...
  int BASS_StreamCreate(
    ...
    return _BASS_StreamCreate(freq, chans, flags, proc, user);
  }

  late final _BASS_StreamCreatePtr =
      _lookup<
        ffi.NativeFunction<
          HSTREAM Function(
            DWORD,
            DWORD,
            DWORD,
            ffi.Pointer<STREAMPROC>,
            ffi.Pointer<ffi.Void>,
          )
        >
      >('BASS_StreamCreate');
  late final _BASS_StreamCreate =
      _BASS_StreamCreatePtr.asFunction<
        int Function(
          int,
          int,
          int,
  ...
  int BASS_StreamCreateURL(
    ...
    return _BASS_StreamCreateURL(url, offset, flags, proc, user);
  }

  late final _BASS_StreamCreateURLPtr =
      _lookup<
        ffi.NativeFunction<
          HSTREAM Function(
  ...
  late final _BASS_StreamCreateURL =
      _BASS_StreamCreateURLPtr.asFunction<
        int Function(
          ffi.Pointer<ffi.Char>,
          int,
          int,
  ...
  int BASS_StreamCreateFileUser(
    ...
    return _BASS_StreamCreateFileUser(system, flags, proc, user);
  }

  late final _BASS_StreamCreateFileUserPtr =
      _lookup<
        ffi.NativeFunction<
          HSTREAM Function(
            DWORD,
  ...
  int BASS_StreamGetFilePosition(int handle, int mode) {
    return _BASS_StreamGetFilePosition(handle, mode);
  }
  ...
  int BASS_StreamPutData(int handle, ffi.Pointer<ffi.Void> buffer, int length) {
    return _BASS_StreamPutData(handle, buffer, length);
  }

  late final _BASS_StreamPutDataPtr =
      _lookup<
        ffi.NativeFunction<
          DWORD Function(HSTREAM, ffi.Pointer<ffi.Void>, DWORD)
        >
      >('BASS_StreamPutData');
  late final _BASS_StreamPutData =
      _BASS_StreamPutDataPtr.asFunction<
  ...
  int BASS_StreamPutFileData(
    ...
    return _BASS_StreamPutFileData(handle, buffer, length);
  }

  late final _BASS_StreamPutFileDataPtr =
      _lookup<
        ffi.NativeFunction<
          DWORD Function(HSTREAM, ffi.Pointer<ffi.Void>, DWORD)
        >
      >('BASS_StreamPutFileData');
  late final _BASS_StreamPutFileData =
      _BASS_StreamPutFileDataPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>, int)
      >();
  ...
  int BASS_MusicLoad(
    ...
    return _BASS_MusicLoad(mem, file, offset, length, flags, freq);
  }

  late final _BASS_MusicLoadPtr =
      _lookup<
        ffi.NativeFunction<
          HMUSIC Function(
            BOOL,
        ...
        >
      >('BASS_MusicLoad');
  late final _BASS_MusicLoad =
      _BASS_MusicLoadPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>, int, int, int, int)
      >();

  int BASS_MusicFree(int handle) {
    return _BASS_MusicFree(handle);
  }
  ...
  int BASS_RecordGetDeviceInfo(int device, ffi.Pointer<BASS_DEVICEINFO> info) {
    return _BASS_RecordGetDeviceInfo(device, info);
  }

  late final _BASS_RecordGetDeviceInfoPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(DWORD, ffi.Pointer<BASS_DEVICEINFO>)>
  ...
  int BASS_RecordInit(int device) {
    return _BASS_RecordInit(device);
  }

  late final _BASS_RecordInitPtr =
      _lookup<ffi.NativeFunction<BOOL Function(ffi.Int)>>('BASS_RecordInit');
  ...
  late final _BASS_RecordFreePtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'BASS_RecordFree',
  );
  late final _BASS_RecordFree =
      _BASS_RecordFreePtr.asFunction<int Function()>();

  int BASS_RecordSetDevice(int device) {
    return _BASS_RecordSetDevice(device);
  }
  ...
  int BASS_RecordGetInfo(ffi.Pointer<BASS_RECORDINFO> info) {
    return _BASS_RecordGetInfo(info);
  }
  ...
  late final _BASS_RecordGetInfo =
      _BASS_RecordGetInfoPtr.asFunction<
        int Function(ffi.Pointer<BASS_RECORDINFO>)
      >();

  ffi.Pointer<ffi.Char> BASS_RecordGetInputName(int input) {
    return _BASS_RecordGetInputName(input);
  }
  ...
  late final _BASS_RecordGetInputName =
      _BASS_RecordGetInputNamePtr.asFunction<
        ffi.Pointer<ffi.Char> Function(int)
      >();

  int BASS_RecordSetInput(int input, int flags, double volume) {
    return _BASS_RecordSetInput(input, flags, volume);
  }

  late final _BASS_RecordSetInputPtr =
      _lookup<ffi.NativeFunction<BOOL Function(ffi.Int, DWORD, ffi.Float)>>(
        'BASS_RecordSetInput',
      );
  late final _BASS_RecordSetInput =
      _BASS_RecordSetInputPtr.asFunction<int Function(int, int, double)>();

  int BASS_RecordGetInput(int input, ffi.Pointer<ffi.Float> volume) {
    return _BASS_RecordGetInput(input, volume);
  }

  late final _BASS_RecordGetInputPtr =
      _lookup<
        ffi.NativeFunction<DWORD Function(ffi.Int, ffi.Pointer<ffi.Float>)>
      >('BASS_RecordGetInput');
  late final _BASS_RecordGetInput =
      _BASS_RecordGetInputPtr.asFunction<
  ...
  int BASS_RecordStart(
    ...
    return _BASS_RecordStart(freq, chans, flags, proc, user);
  }

  late final _BASS_RecordStartPtr =
      _lookup<
        ffi.NativeFunction<
          HRECORD Function(
            DWORD,
            DWORD,
            DWORD,
            ffi.Pointer<RECORDPROC>,
            ffi.Pointer<ffi.Void>,
          )
        >
      >('BASS_RecordStart');
  late final _BASS_RecordStart =
      _BASS_RecordStartPtr.asFunction<
        int Function(
          int,
          int,
          int,
  ...
  int BASS_ChannelGetDevice(int handle) {
    return _BASS_ChannelGetDevice(handle);
  }
  ...
  int BASS_ChannelSetDevice(int handle, int device) {
  ...
  int BASS_ChannelGetInfo(int handle, ffi.Pointer<BASS_CHANNELINFO> info) {
    return _BASS_ChannelGetInfo(handle, info);
  }

  late final _BASS_ChannelGetInfoPtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(DWORD, ffi.Pointer<BASS_CHANNELINFO>)>
      >('BASS_ChannelGetInfo');
  late final _BASS_ChannelGetInfo =
      _BASS_ChannelGetInfoPtr.asFunction<
        int Function(int, ffi.Pointer<BASS_CHANNELINFO>)
      >();

  ffi.Pointer<ffi.Char> BASS_ChannelGetTags(int handle, int tags) {
    return _BASS_ChannelGetTags(handle, tags);
  }

  late final _BASS_ChannelGetTagsPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(DWORD, DWORD)>>(
        'BASS_ChannelGetTags',
      );
  late final _BASS_ChannelGetTags =
      _BASS_ChannelGetTagsPtr.asFunction<
        ffi.Pointer<ffi.Char> Function(int, int)
      >();

  int BASS_ChannelFlags(int handle, int flags, int mask) {
    return _BASS_ChannelFlags(handle, flags, mask);
  }
  ...
  int BASS_ChannelLock(int handle, int lock) {
    return _BASS_ChannelLock(handle, lock);
  }
  ...
  int BASS_ChannelFree(int handle) {
    return _BASS_ChannelFree(handle);
  }
  ...
  int BASS_ChannelPlay(int handle, int restart) {
    return _BASS_ChannelPlay(handle, restart);
  }
  ...
  int BASS_ChannelUpdate(int handle, int length) {
    return _BASS_ChannelUpdate(handle, length);
  }
  ...
  int BASS_ChannelIsSliding(int handle, int attrib) {
    return _BASS_ChannelIsSliding(handle, attrib);
  }
  ...
  int BASS_ChannelSetAttributeEx(
    ...
    return _BASS_ChannelSetAttributeEx(handle, attrib, value, size);
  }

  late final _BASS_ChannelSetAttributeExPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(DWORD, DWORD, ffi.Pointer<ffi.Void>, DWORD)
        >
  ...
  int BASS_ChannelGetAttributeEx(
    ...
    return _BASS_ChannelGetAttributeEx(handle, attrib, value, size);
  }

  late final _BASS_ChannelGetAttributeExPtr =
      _lookup<
        ffi.NativeFunction<
          DWORD Function(DWORD, DWORD, ffi.Pointer<ffi.Void>, DWORD)
        >
  ...
  late final _BASS_ChannelSet3DAttributesPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
            DWORD,
  ...
  late final _BASS_ChannelSet3DAttributes =
      _BASS_ChannelSet3DAttributesPtr.asFunction<
  ...
  late final _BASS_ChannelGet3DAttributesPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
            DWORD,
  ...
  int BASS_ChannelSet3DPosition(
    ...
    return _BASS_ChannelSet3DPosition(handle, pos, orient, vel);
  }

  late final _BASS_ChannelSet3DPositionPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
            DWORD,
  ...
  int BASS_ChannelGet3DPosition(
    ...
    return _BASS_ChannelGet3DPosition(handle, pos, orient, vel);
  }

  late final _BASS_ChannelGet3DPositionPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(
            DWORD,
  ...
  int BASS_ChannelGetLevel(int handle) {
    return _BASS_ChannelGetLevel(handle);
  }
  ...
  int BASS_ChannelGetLevelEx(
    ...
    return _BASS_ChannelGetLevelEx(handle, levels, length, flags);
  }

  late final _BASS_ChannelGetLevelExPtr =
      _lookup<
        ffi.NativeFunction<
          BOOL Function(DWORD, ffi.Pointer<ffi.Float>, ffi.Float, DWORD)
        >
      >('BASS_ChannelGetLevelEx');
  late final _BASS_ChannelGetLevelEx =
      _BASS_ChannelGetLevelExPtr.asFunction<
  ...
  late final _BASS_ChannelGetDataPtr =
      _lookup<
        ffi.NativeFunction<DWORD Function(DWORD, ffi.Pointer<ffi.Void>, DWORD)>
      >('BASS_ChannelGetData');
  late final _BASS_ChannelGetData =
      _BASS_ChannelGetDataPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>, int)
      >();
  ...
  int BASS_ChannelSetSync(
    ...
    return _BASS_ChannelSetSync(handle, type, param, proc, user);
  }

  late final _BASS_ChannelSetSyncPtr =
      _lookup<
        ffi.NativeFunction<
          HSYNC Function(
            DWORD,
            DWORD,
            QWORD,
            ffi.Pointer<SYNCPROC>,
            ffi.Pointer<ffi.Void>,
          )
        >
      >('BASS_ChannelSetSync');
  late final _BASS_ChannelSetSync =
      _BASS_ChannelSetSyncPtr.asFunction<
        int Function(
          int,
          int,
          int,
  ...
  int BASS_ChannelRemoveSync(int handle, int sync$) {
    return _BASS_ChannelRemoveSync(handle, sync$);
  }
  ...
  int BASS_ChannelSetLink(int handle, int chan) {
    return _BASS_ChannelSetLink(handle, chan);
  }
  ...
  int BASS_ChannelRemoveLink(int handle, int chan) {
    return _BASS_ChannelRemoveLink(handle, chan);
  }
  ...
  int BASS_ChannelSetDSP(
    ...
    return _BASS_ChannelSetDSP(handle, proc, user, priority);
  }

  late final _BASS_ChannelSetDSPPtr =
      _lookup<
        ffi.NativeFunction<
          HDSP Function(
            DWORD,
        ...
        >
      >('BASS_ChannelSetDSP');
  late final _BASS_ChannelSetDSP =
      _BASS_ChannelSetDSPPtr.asFunction<
        int Function(int, ffi.Pointer<DSPPROC>, ffi.Pointer<ffi.Void>, int)
      >();

  int BASS_ChannelRemoveDSP(int handle, int dsp) {
    return _BASS_ChannelRemoveDSP(handle, dsp);
  }
  ...
  int BASS_FXGetParameters(int handle, ffi.Pointer<ffi.Void> params) {
    return _BASS_FXGetParameters(handle, params);
  }
  ...
  late final _BASS_FXGetParameters =
      _BASS_FXGetParametersPtr.asFunction<
        int Function(int, ffi.Pointer<ffi.Void>)
      >();

  int BASS_FXSetPriority(int handle, int priority) {
    return _BASS_FXSetPriority(handle, priority);
  }

  late final _BASS_FXSetPriorityPtr =
      _lookup<ffi.NativeFunction<BOOL Function(HFX, ffi.Int)>>(
        'BASS_FXSetPriority',
      );
  late final _BASS_FXSetPriority =
      _BASS_FXSetPriorityPtr.asFunction<int Function(int, int)>();

  int BASS_FXReset(int handle) {
    return _BASS_FXReset(handle);
  }
...
final class BASS_RECORDINFO extends ffi.Struct {
  @DWORD()
  external int flags;
...
final class BASS_SAMPLE extends ffi.Struct {
  @DWORD()
  external int freq;
...
final class BASS_CHANNELINFO extends ffi.Struct {
  @DWORD()
  external int freq;
...
final class BASS_PLUGINFORM extends ffi.Struct {
  @DWORD()
  external int ctype;

  external ffi.Pointer<ffi.Char> name;

  external ffi.Pointer<ffi.Char> exts;
}

final class BASS_PLUGININFO extends ffi.Struct {
  @DWORD()
...
final class BASS_3DVECTOR extends ffi.Struct {
  @ffi.Float()
  external double x;
...
typedef FILELENPROC =
    ffi.NativeFunction<QWORD Function(ffi.Pointer<ffi.Void> user)>;
typedef FILEREADPROC =
    ffi.NativeFunction<
      DWORD Function(
        ffi.Pointer<ffi.Void> buffer,
        DWORD length,
...
typedef FILESEEKPROC =
    ffi.NativeFunction<BOOL Function(QWORD offset, ffi.Pointer<ffi.Void> user)>;

final class BASS_FILEPROCS extends ffi.Struct {
...
final class TAG_ID3 extends ffi.Struct {
  @ffi.Array.multi([3])
  ...
  @ffi.Array.multi([4])
  external ffi.Array<ffi.Char> year;
...
final class TAG_APE_BINARY extends ffi.Struct {
...
final class TAG_BEXT extends ffi.Opaque {}

final class TAG_CART_TIMER extends ffi.Struct {
  @DWORD()
...
final class TAG_CART extends ffi.Opaque {}

final class TAG_CUE_POINT extends ffi.Struct {
  @DWORD()
  external int dwName;
...
final class TAG_CUE extends ffi.Opaque {}

final class TAG_SMPL_LOOP extends ffi.Struct {
  @DWORD()
...
final class TAG_SMPL extends ffi.Opaque {}

final class TAG_CA_CODEC extends ffi.Struct {
  @DWORD()
  external int ftype;
...
@ffi.Packed(1)
final class tWAVEFORMATEX extends ffi.Struct {
  @WORD()
...
typedef PWAVEFORMATEX = ffi.Pointer<tWAVEFORMATEX>;
typedef LPWAVEFORMATEX = ffi.Pointer<tWAVEFORMATEX>;
typedef LPCWAVEFORMATEX = ffi.Pointer<WAVEFORMATEX>;

final class BASS_DX8_CHORUS extends ffi.Struct {
  @ffi.Float()
...
final class BASS_DX8_COMPRESSOR extends ffi.Struct {
  @ffi.Float()
...
final class BASS_DX8_DISTORTION extends ffi.Struct {
  @ffi.Float()
  external double fGain;
...
final class BASS_DX8_ECHO extends ffi.Struct {
  @ffi.Float()
  external double fWetDryMix;
...
final class BASS_DX8_FLANGER extends ffi.Struct {
  @ffi.Float()
  external double fWetDryMix;
...
final class BASS_DX8_GARGLE extends ffi.Struct {
  @DWORD()
...
final class BASS_DX8_I3DL2REVERB extends ffi.Struct {
  @ffi.Int()
  external int lRoom;
...
final class BASS_DX8_REVERB extends ffi.Struct {
  @ffi.Float()
...
final class BASS_FX_VOLUME_PARAM extends ffi.Struct {
  @ffi.Float()
...
typedef IOSNOTIFYPROC = ffi.NativeFunction<ffi.Void Function(DWORD status)>;
...
const int BASS_CONFIG_NORAMP = 74;
...
const int BASS_CONFIG_ANDROID_JAVAVM = 63;

const int BASS_CONFIG_LIBSSL = 64;

const int BASS_CONFIG_FILENAME = 75;
...
const int BASS_SPEAKER_SIDE = 67108864;
...
const int BASS_SPEAKER_SIDELEFT = 335544320;

const int BASS_SPEAKER_SIDERIGHT = 603979776;
